...
namespace AlmacenWeb.Controllers
{
    ...
    public class ProveedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProveedorId,NombreEmpresa,NombreContacto,Cuit,Direccion,Telefono,Email")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorId,NombreEmpresa,NombreContacto,Cuit,Direccion,Telefono,Email")] Proveedor proveedor)
        {
